...
export default function Admin() {
  ...
  const adminPath = '/sk-admin-2024-secure';
  const correctPassword = 'SKCleaning2024!'; // Change this to a secure password
          ...
          <CardContent>
            ...
            <div className="mt-4 text-center">
              <p className="text-xs text-gray-500">
                Secure admin access for SK Cleaning Services
              </p>
      ...
      <div className="bg-[#36454F] text-white p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-semibold">SK Cleaning Admin Panel</h1>
          </div>
